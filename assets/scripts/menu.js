...
/** @constant {string} SVG_NS - SVG namespace for menu elements */
const SVG_NS = 'http://www.w3.org/2000/svg';

/** @constant {Object} CONFIG - Configuration for radial menu and welcome carousel */
const CONFIG = {
  ...
  NEURON_COUNT_MIN: 4, // Minimum grid particles
  NEURON_COUNT_MAX: 12, // Maximum grid particles
  SECTOR_FILL: 'rgba(180, 220, 255, 0.08)', // Sector fill color
  STROKE_COLOR: '#fff', // Stroke color for menu elements
  BACKGROUND_RADIUS: 192, // Stationary ring radius (handled in main.js)
  ...
  LABELS: ['Contact', 'AI', 'Work', 'Media', 'Shop', 'About'], // Menu sector labels
 ...
 * @param {Object} pos - Sector position data (p1, p2, p3, p4, iconPos, start, end)
 * @param {string} label - Sector label (e.g., 'Contact')
 * @param {string} color - Sector fill color
...
function initRadialMenu() {
  ...
  CONFIG.RING_RADII.forEach((r, i) => {
    ...
    ring.setAttribute('stroke', CONFIG.STROKE_COLOR);
